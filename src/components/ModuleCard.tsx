...
export const ModuleCard: React.FC<ModuleCardProps> = ({ module, instanceId, onDragStart, onDragEnd, isDraggable = false, hasError = false, errorTooltip, isLocked = false, onToggleLock }) => {
  ...
  return (
      ...
      >
          ...
          {hasError && (
              <div className="absolute top-0 right-0 -mt-1 -mr-1" aria-label="Platzierungsfehler">
          ...
          {onToggleLock && (
            <button
                ...
                aria-label={isLocked ? "Modul entsperren" : "Modul sperren"}
                title={isLocked ? "Modul entsperren" : "Modul sperren"}
            >
